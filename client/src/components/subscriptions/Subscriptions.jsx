...
const Inscricoes = () => {
  ...
  useEffect(() => {
    const fetchInscricoes = async () => {
      try {
        const response = await axios.get("https://5daa-2804-29b8-500a-1274-e81e-e223-a60-a299.ngrok-free.app/users/subscriptions", {
  ...
  const handleRemoveMinicurso = async (enrollmentId) => {
    try {
      await axios.delete(`https://5daa-2804-29b8-500a-1274-e81e-e223-a60-a299.ngrok-free.app/subscriptions/minicourses/${enrollmentId}`, {
        withCredentials: true, // Enviar cookies de autenticação
      });
  ...
  const handleRemovePalestra = async (enrollmentId) => {
    try {
      await axios.delete(`https://5daa-2804-29b8-500a-1274-e81e-e223-a60-a299.ngrok-free.app/subscriptions/lectures/${enrollmentId}`, {
        withCredentials: true, // Enviar cookies de autenticação
      });
      setToast({ show: true, message: "Inscrição excluída!", type: "success" });
