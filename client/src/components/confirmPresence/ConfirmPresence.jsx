  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      const presenceUrl = type === "minicourse" 
        ? `https://5daa-2804-29b8-500a-1274-e81e-e223-a60-a299.ngrok-free.app/minicourses/auth/${eventId}` 
        : `https://5daa-2804-29b8-500a-1274-e81e-e223-a60-a299.ngrok-free.app/lectures/auth/${eventId}`;
      ...
      if (presenceResponse.status === 200) {
        ...
        const certificateResponse = await axios.post('https://5daa-2804-29b8-500a-1274-e81e-e223-a60-a299.ngrok-free.app/certificates/', {
          eventId: eventId,
          eventType: eventType,
        }, {
